...
4. If unsure which register to use, default to the tutorial/guide voice in the billiards and guitar samples—clear, stepwise, lightly conversational—and escalate formality only as the topic demands (as in *Get Funded*).
